...
User.create!(email: 'user@lewagon.com',first_name: 'Roni',last_name: 'Talvi', nickname: 'Roni V', profile_type: 'Junior Racer', occupation: 'Software engineer', photo:'https://res.cloudinary.com/diciu4xpu/image/upload/v1551801252/chaserz/avatars/rony.jpg', password: '123123', points: 99, age: 20, nationality: 'Israel')
print '.user.'.green
